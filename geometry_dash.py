...
GAME_SPEED = 5    # Keep the same speed
...
class BackgroundEffect:
    ...
    def update(self):
        ...
        for line in self.lines:
            line['x'] -= line['speed'] * (GAME_SPEED / 3)
        ...
        for shape in self.shapes:
            shape['x'] -= shape['speed'] * (GAME_SPEED / 3)
...
class Obstacle:
    def __init__(self, x, shape_type):
        self.x = x
...
def show_score(score):
    ...
    text = font.render(f"Score: {score}", True, (0, 255, 255))  # Neon cyan
    ...
    while True:
        ...
        if not game_over:
            ...
            if can_spawn and current_time - last_obstacle_time > random.randint(1500, 2500):
                ...
                obstacles.append(Obstacle(WIDTH, shape_type))
